...
# Quitamos la importación de Qwen si no está instalada o usamos un try/except
try:
...
class RAGVT5(torch.nn.Module):
    def __init__(self, config: dict):
        ...
        # === CORRECCIÓN AQUÍ: Forzamos minúsculas para evitar errores ===
        pr = config.get("page_retrieval")
        self.page_retrieval = pr.lower() if pr else None
        # ================================================================
    ...
    def forward(
        ...
        # === INICIALIZAMOS RESULT PARA EVITAR ERROR ===
